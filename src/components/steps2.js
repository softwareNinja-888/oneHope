          ...
          <div className="steps2-container3">
            <div className="steps2-container4 thq-card">
              <h2 className="thq-heading-2">
                {props.step1Title ?? (
                  <Fragment>
                    <span className="steps2-text29">Our Mission</span>
                  </Fragment>
                )}
              </h2>
                ...
                {props.step1Description ?? (
                  <Fragment>
                    <span className="steps2-text25">
                      Learn about our church&apos;s mission to serve the
                      community and spread love and compassion.
                    </span>
                  </Fragment>
                )}
              </span>
            ...
            <div className="steps2-container5 thq-card">
              <h2 className="thq-heading-2">
                {props.step2Title ?? (
                  <Fragment>
                    <span className="steps2-text27">Our Values</span>
                  </Fragment>
                )}
              </h2>
                ...
                {props.step2Description ?? (
                  <Fragment>
                    <span className="steps2-text28">
                      Discover the core values that guide our church&apos;s
            ...
            <div className="steps2-container6 thq-card">
              <h2 className="thq-heading-2">
                {props.step3Title ?? (
                  <Fragment>
                    <span className="steps2-text30">Our Team</span>
                  </Fragment>
                )}
              </h2>
                ...
                {props.step3Description ?? (
                  <Fragment>
                    <span className="steps2-text26">
                      Meet the dedicated individuals who lead and support our
                      church in its various ministries.
                    </span>
                  </Fragment>
                )}
              </span>
            ...
            <div className="steps2-container7 thq-card">
              <h2 className="thq-heading-2">
                {props.step4Title ?? (
                  <Fragment>
                    <span className="steps2-text32">Get Involved</span>
                  </Fragment>
                )}
              </h2>
                ...
                {props.step4Description ?? (
                  <Fragment>
                    <span className="steps2-text31">
                      Find out how you can become a part of our church community
                      and contribute to our shared mission.
                    </span>
                  </Fragment>
                )}
              </span>
